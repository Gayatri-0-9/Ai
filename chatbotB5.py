...
def respond(user_input):
    if any(greeting in user_input.lower() for greeting in ['hi','hey','hello']):
        return "Hello! How can I assist you with your fashion today?"
    elif 'best outfit for' in user_input.lower():
        return 'The best outfit depends on the occasion.Can you tell me more about the occasion'
    elif 'casual' in user_input.lower():
        return 'How about a pair of jeans with a comfortable t-shirt or blouse?'
    elif 'fancy' in user_input.lower():
        return 'A formal suit or dress would be perfect.Do you have a colour preference?'
    else:
